...
Эта папка содержит пользовательские и релизные инструкции для версии 4.0.0. README в корне проекта оставлен как краткая карта, а подробные сценарии вынесены сюда.

## Быстрые ссылки

- [История изменений](../CHANGELOG.md) - release notes и миграционные заметки 4.0.0.
...
- Для финальной проверки версии 4.0.0 сверяйте [историю изменений](../CHANGELOG.md) и release checklist.
