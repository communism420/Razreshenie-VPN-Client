...
Эта папка содержит пользовательские и релизные инструкции для версии 3.2.0. README в корне проекта оставлен как краткая карта, а подробные сценарии вынесены сюда.
